...
interface MessagePreferencesWindowProps {
  show: boolean;
  onClose: () => void;
...
export const MessagePreferencesWindow: React.FC<MessagePreferencesWindowProps> = ({
  show,
  onClose,
  windowState,
  setWindowState
  ...
  return (
    ...
    >
      <div onMouseDown={handleDrag} className="h-[26px] bg-gradient-to-b from-[#fefefe] to-[#d1d1d1] flex items-center justify-between px-2 cursor-default shrink-0 border-b border-gray-400">
        <span className="text-black font-medium text-[11.5px] tracking-tight">Message Preferences - Setup</span>
      ...
      <div className="flex-1 p-1.5 flex flex-col overflow-hidden">
        <div className="flex-1 border border-gray-400 bg-white overflow-hidden shadow-inner flex flex-col">
          <div className="flex bg-[#e4e4e4] border-b border-gray-400 divide-x divide-gray-400 font-medium">
            ...
            <div className="flex-1 px-2 py-1">Area</div>
            <div className="flex-1 px-2 py-1">Form Name</div>
            <div className="flex-[2] px-2 py-1">Message Text</div>
