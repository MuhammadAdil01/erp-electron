    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5">
          <span className="text-black font-medium text-[11.5px] tracking-tight">Change Password</span>
        </div>
      ...
      <div className="flex-1 p-6 bg-[#f8f8f8] mx-1.5 my-1.5 border border-gray-300 shadow-sm overflow-y-auto custom-scrollbar">
        <div className="mb-6 space-y-1">
           <p className="text-[11px] text-gray-800">Choose a new password that complies with your company's password policy</p>
           <p className="text-[11px] text-gray-800">The password must contain:</p>
           <p className="text-[11px] text-gray-800 font-medium">Minimum of 4 Characters in Length.</p>
        </div>

        <div className="grid grid-cols-[120px_150px] gap-x-4 gap-y-1.5 items-center mt-8">
           <span className={sapLabelStyle}>Password Example:</span>
           <input type="text" className={`${sapInputStyle} bg-gray-200`} defaultValue="abcd" readOnly />

           <div className="col-span-2 h-4" />

           <span className={sapLabelStyle}>Old Password</span>
           <input type="password" className={sapYellowInputStyle} />

           <span className={sapLabelStyle}>New Password</span>
           <input type="password" className={sapInputStyle} />

           <span className={sapLabelStyle}>Confirm</span>
           <input type="password" className={sapInputStyle} />
        </div>
      </div>
