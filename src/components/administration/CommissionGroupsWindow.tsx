...
interface CommissionGroupsWindowProps {
  show: boolean;
  onClose: () => void;
...
export const CommissionGroupsWindow: React.FC<CommissionGroupsWindowProps> = ({
  show,
  onClose,
  windowState,
  setWindowState
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[26px] bg-gradient-to-b from-[#fefefe] to-[#d1d1d1] flex items-center justify-between px-2 cursor-default shrink-0 border-b border-gray-400">
        <span className="text-black font-medium text-[11.5px] tracking-tight">Commission Groups - Setup</span>
      ...
      <div className="flex-1 p-1.5 flex flex-col overflow-hidden">
        <div className="flex-1 border border-gray-400 bg-white overflow-hidden shadow-inner flex flex-col">
          ...
          <div className="flex bg-[#e4e4e4] border-b border-gray-400 divide-x divide-gray-400 font-medium text-[10.5px]">
            ...
            <div className="flex-[2] px-2 py-1">Commission Group Name</div>
            <div className="flex-1 px-2 py-1">Commission Percentage</div>
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar bg-[repeating-linear-gradient(white,white_19px,#f5f5f5_19px,#f5f5f5_20px)]">
             <div className="flex border-b border-gray-200 divide-x divide-gray-200 h-[20px] items-center">
                <div className="w-[30px] px-1 text-center text-gray-500 font-bold">1</div>
                <div className="flex-[2] px-2 h-full flex items-center">User-Defined Commission</div>
                <div className="flex-1 px-2 h-full flex items-center"></div>
             </div>
             <div className="flex border-b border-gray-200 divide-x divide-gray-200 h-[20px] items-center">
                <div className="w-[30px] px-1 text-center text-gray-500 font-bold">2</div>
                <div className="flex-[2] px-2 h-full flex items-center bg-[#fffbd5]"></div>
                <div className="flex-1 px-2 h-full flex items-center"></div>
             </div>
             {Array(15).fill(null).map((_, i) => (
                <div key={i} className="flex border-b border-gray-200 divide-x divide-gray-200 h-[20px] items-center">
                   <div className="w-[30px] px-1 text-center text-gray-500 font-bold">{i + 3}</div>
