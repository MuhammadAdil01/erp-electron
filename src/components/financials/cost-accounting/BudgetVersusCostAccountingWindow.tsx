...
export const BudgetVersusCostAccountingWindow: React.FC<Props> = ({
  ...
  return (
    <ResizableCriteriaWindow
      title="Budget Versus Cost Accounting - Selection Criteria"
      windowState={windowState}
      onClose={onClose}
    ...
    >
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-center gap-4 pt-2">
          <span className="text-[11px] text-[#333] w-24 shrink-0 px-2 underline italic">Scenario</span>
          <div className="w-48 h-5 border border-gray-400 bg-white flex items-center px-1 shadow-inner">
