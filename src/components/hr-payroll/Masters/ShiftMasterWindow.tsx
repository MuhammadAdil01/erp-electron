...
interface ShiftMasterWindowProps {
  show: boolean;
  onClose: () => void;
...
export const ShiftMasterWindow: React.FC<ShiftMasterWindowProps> = ({
  show,
  onClose,
  windowState,
  setWindowState
    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5">
          <span className="text-black font-medium text-[12px] tracking-tight">Shift Master</span>
        </div>
      ...
      <div className="flex-1 flex flex-col p-2 overflow-hidden bg-white m-1.5 border border-gray-400 shadow-inner">
        <div className="p-4 flex flex-col gap-1.5">
          ...
          <div className="grid grid-cols-[140px_1fr] items-center gap-y-3">
            <span className={sapLabelStyle}>Shift Code</span>
            <input type="text" className={sapInputStyle} />

            <span className={sapLabelStyle}>Shift Description*</span>
            <input type="text" className={sapInputStyle} />

            <span className={sapLabelStyle}>Shift Start Time *</span>
            <input type="text" className={sapInputStyle} />

            <span className={sapLabelStyle}>Shift End Time *</span>
            <input type="text" className={sapInputStyle} />

            <span className={sapLabelStyle}>Lunch Break Hours</span>
            <input type="text" className={sapInputStyle} />
