...
export const ContentsTabPQ: React.FC = () => {
  const headers = [
    '#', 'Item No.', 'Quoted Qty.', 'Unit Price', 'Discount %', 'Tax Code', 'Total (LC)', 
    'Quoted Date', 'Country/Region of Origin', 'Distr. Rule', 'Required Qty.', 
    'Required Date', 'UoM Code', 'Blanket Agreement No.', 'Retention %', 'IPC No.', 'Rejected Quantity'
  ];
