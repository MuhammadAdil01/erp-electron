...
export const ContentsTabGRPO: React.FC = () => {
  const headers = [
    '#', 'Item No.', 'BP Catalog No.', 'Item Description', 'Quantity', 'Unit Price', 
    'Discount %', 'Tax Code', 'Total (LC)', 'Distr. Rule', 'UoM Code', 
    'Country/Region of Origin', 'Blanket Agreement No.', 'Standard Item Identification'
  ];
