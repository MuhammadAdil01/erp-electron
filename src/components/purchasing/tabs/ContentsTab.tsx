...
export const ContentsTab: React.FC = () => {
  const headers = [
    '#', 'Item No.', 'Item Description', 'Required Qty.', 
    'Info Price', 'Discount %', 'Tax Code', 'Total (LC)', 
    'Distr. Rule', 'Required Date', 'UoM Code', 'Vendor'
  ];
      ...
      <div className="flex-1 border border-[#d4d0c8] bg-white overflow-y-auto custom-scrollbar">
        <ClassicTable headers={headers} rowCount={12}>
          <tr className="border-b border-[#f0f0f0] h-[18px]">
            ...
            <td className="border-r border-[#f0f0f0]"></td>
            <td className="border-r border-[#f0f0f0] text-center"></td>
            <td className="border-r border-[#f0f0f0]"></td>
            <td className="border-r border-[#f0f0f0]"></td>
          </tr>
        </ClassicTable>
