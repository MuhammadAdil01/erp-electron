...
export const AccountingTabAPInvoice: React.FC = () => (
  <div className="flex-1 flex p-2 gap-8 bg-white overflow-y-auto">
    ...
    <div className="flex flex-col gap-1 w-[400px]">
       ...
       <FieldRow label="Installments" labelWidth="150px">
          <div className="flex flex-1 items-center gap-1">
             ...
             <ClassicInput className="w-[40px] text-center" defaultValue="1" />
          </div>
       </FieldRow>
       <div className="h-2" />
       <div className="flex items-center gap-2 mb-1">
       ...
       <div className="flex items-center gap-2 mb-1">
          ...
          <div className="flex items-center gap-1">
             <input type="checkbox" className="w-3 h-3" />
             <span className="text-[10.5px]">Net Procedure</span>
          </div>
       </div>
       <div className="h-4" />
