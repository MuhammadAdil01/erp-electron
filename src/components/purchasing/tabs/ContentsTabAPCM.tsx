...
export const ContentsTabAPCM: React.FC = () => {
  const headers = [
    '#', 'Item No.', 'Quantity', 'Unit Price', 'Discount %', 'Tax Code', 'WTax Liable', 'Total (LC)', 
    'Distr. Rule', 'Country/Region of Origin', 'UoM Code', 'Blanket Agreement No.', 
      ...
      <div className="flex-1 border border-[#d4d0c8] bg-white overflow-y-auto custom-scrollbar overflow-x-auto">
        <ClassicTable headers={headers} rowCount={12}>
          <tr className="border-b border-[#f0f0f0] h-[18px]">
            ...
            <td className="border-r border-[#f0f0f0]"><ClassicInput className="w-full border-none shadow-none text-right focus:bg-[#ffed99]" /></td>
            <td className="border-r border-[#f0f0f0]"><ClassicInput className="w-full border-none shadow-none text-right focus:bg-[#ffed99]" /></td>
            ...
            <td className="border-r border-[#f0f0f0] text-center leading-none"><input type="checkbox" className="w-2.5 h-2.5" /></td>
