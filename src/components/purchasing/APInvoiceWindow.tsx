...
import { X, Minus, Square, ChevronRight, Info } from 'lucide-react';
import { 
  ClassicTab, ClassicInput, ClassicSel, YellowBtn, GreyBtn, FieldRow, cn 
} from '../ui/ClassicERPUI';
import { ContentsTabAPInvoice } from './tabs/ContentsTabAPInvoice';
import { LogisticsTabAPInvoice } from './tabs/LogisticsTabAPInvoice';
import { AccountingTabAPInvoice } from './tabs/AccountingTabAPInvoice';
import { AttachmentsTabAPInvoice } from './tabs/AttachmentsTabAPInvoice';
...
interface APInvoiceWindowProps {
...
export const APInvoiceWindow: React.FC<APInvoiceWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default">
        <span className="text-white text-[11px] font-bold">A/P Invoice</span>
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden bg-[#f0f0f0]">
          ...
          <div className="w-[200px]">
             <div className="flex items-center gap-1 mb-1">
                ...
                <div className="flex gap-0.5">
                   <ClassicInput value="1408" className="w-[50px] text-right" readOnly />
                </div>
             </div>
             ...
             <FieldRow label="IPC No" labelWidth="80px">
                <ClassicInput className="w-full" />
             </FieldRow>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white border border-[#808080] border-t-0 flex flex-col overflow-hidden">
          {activeTab === 'Contents' && <ContentsTabAPInvoice />}
          {activeTab === 'Logistics' && <LogisticsTabAPInvoice />}
          {activeTab === 'Accounting' && <AccountingTabAPInvoice />}
          {activeTab === 'Attachments' && <AttachmentsTabAPInvoice />}
        </div>
        ...
        <div className="flex justify-between mt-1 items-end">
           <div className="flex flex-col gap-1 w-[400px]">
              ...
              <FieldRow label="Employee" labelWidth="80px"><ClassicInput className="flex-1" /></FieldRow>
           ...
           <div className="flex flex-col gap-1 w-[280px]">
              <FieldRow label="Total Before Discount" labelWidth="130px"><ClassicInput className="w-full bg-[#f0f0f0]" readOnly /></FieldRow>
              <div className="flex gap-2 items-center mb-1">
                <div className="text-[10.5px] w-[130px] shrink-0">Discount</div>
                <ClassicInput className="w-[45px] text-right" />
              ...
              <div className="flex gap-2 items-center mb-1">
                ...
                <div className="text-[10.5px] flex-1">Total Down Payment</div>
                <ClassicInput className="w-[100px] h-[18px] bg-[#f0f0f0]" readOnly />
              </div>
              <div className="flex gap-2 items-center mb-1">
                <div className="text-[10.5px] w-[130px] shrink-0">Other Charges & Ad</div>
                <div className="bg-[#ffed99] border border-[#f39c12] p-0.5 flex items-center cursor-pointer">
                  <ChevronRight className="w-3 h-3 text-orange-600" />
                </div>
                <ClassicInput className="flex-1 h-[18px] bg-[#f0f0f0]" readOnly />
              </div>
              <FieldRow label="Tax" labelWidth="130px"><ClassicInput className="w-full bg-[#f0f0f0]" readOnly /></FieldRow>
              <FieldRow label="WTax Amount" labelWidth="130px"><ClassicInput className="w-full bg-[#f0f0f0]" readOnly /></FieldRow>
              <FieldRow label="Total Payment Due" labelWidth="130px">
                 <div className="flex w-full items-center gap-1">
                    ...
                    <Info className="w-4 h-4 text-blue-500 fill-blue-500 bg-white rounded-full" />
                 </div>
              </FieldRow>
              <FieldRow label="Applied Amount" labelWidth="130px"><ClassicInput className="w-full bg-[#f0f0f0]" readOnly /></FieldRow>
              <FieldRow label="Balance Due" labelWidth="130px"><ClassicInput className="w-full bg-[#f0f0f0]" readOnly /></FieldRow>
           </div>
        </div>
