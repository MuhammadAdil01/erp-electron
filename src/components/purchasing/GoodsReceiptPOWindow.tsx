...
import { ContentsTabGRPO } from './tabs/ContentsTabGRPO';
import { LogisticsTabGRPO } from './tabs/LogisticsTabGRPO';
import { AccountingTabGRPO } from './tabs/AccountingTabGRPO';
import { AttachmentsTabGRPO } from './tabs/AttachmentsTabGRPO';
...
interface GoodsReceiptPOWindowProps {
...
export const GoodsReceiptPOWindow: React.FC<GoodsReceiptPOWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default">
        <span className="text-white text-[11px] font-bold">Goods Receipt PO</span>
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden bg-[#f0f0f0]">
        ...
        <div className="flex gap-8">
          ...
          <div className="w-[200px]">
             <div className="flex items-center gap-1 mb-1">
                ...
                <ClassicSel className="w-[70px]"><option>gB-GRN</option></ClassicSel>
        ...
        <div className="flex-1 bg-white border border-[#808080] border-t-0 flex flex-col overflow-hidden">
          {activeTab === 'Contents' && <ContentsTabGRPO />}
          {activeTab === 'Logistics' && <LogisticsTabGRPO />}
          {activeTab === 'Accounting' && <AccountingTabGRPO />}
          {activeTab === 'Attachments' && <AttachmentsTabGRPO />}
        </div>
