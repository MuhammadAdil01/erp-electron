...
import { ContentsTabGR } from './tabs/ContentsTabGR';
import { LogisticsTabGR } from './tabs/LogisticsTabGR';
import { AccountingTabGR } from './tabs/AccountingTabGR';
import { AttachmentsTabGR } from './tabs/AttachmentsTabGR';
...
interface GoodsReturnWindowProps {
...
export const GoodsReturnWindow: React.FC<GoodsReturnWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default">
        <span className="text-white text-[11px] font-bold">Goods Return</span>
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden bg-[#f0f0f0]">
        ...
        <div className="flex-1 bg-white border border-[#808080] border-t-0 flex flex-col overflow-hidden">
          {activeTab === 'Contents' && <ContentsTabGR />}
          {activeTab === 'Logistics' && <LogisticsTabGR />}
          {activeTab === 'Accounting' && <AccountingTabGR />}
          {activeTab === 'Attachments' && <AttachmentsTabGR />}
        </div>
