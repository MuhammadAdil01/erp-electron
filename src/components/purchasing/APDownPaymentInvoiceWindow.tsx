...
import { ContentsTabAPI } from './tabs/ContentsTabAPI';
import { LogisticsTabAPI } from './tabs/LogisticsTabAPI';
import { AccountingTabAPI } from './tabs/AccountingTabAPI';
import { AttachmentsTabAPI } from './tabs/AttachmentsTabAPI';
...
interface APDownPaymentInvoiceWindowProps {
...
export const APDownPaymentInvoiceWindow: React.FC<APDownPaymentInvoiceWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default">
        <span className="text-white text-[11px] font-bold">A/P Down Payment Invoice</span>
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden bg-[#f0f0f0]">
        ...
        <div className="flex-1 bg-white border border-[#808080] border-t-0 flex flex-col overflow-hidden">
          {activeTab === 'Contents' && <ContentsTabAPI />}
          {activeTab === 'Logistics' && <LogisticsTabAPI />}
          {activeTab === 'Accounting' && <AccountingTabAPI />}
          {activeTab === 'Attachments' && <AttachmentsTabAPI />}
        </div>
