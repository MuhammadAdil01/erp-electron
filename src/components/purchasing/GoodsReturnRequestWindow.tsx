...
import { ContentsTabGRR } from './tabs/ContentsTabGRR';
import { LogisticsTabGRR } from './tabs/LogisticsTabGRR';
import { AccountingTabGRR } from './tabs/AccountingTabGRR';
import { AttachmentsTabGRR } from './tabs/AttachmentsTabGRR';
...
interface GoodsReturnRequestWindowProps {
...
export const GoodsReturnRequestWindow: React.FC<GoodsReturnRequestWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default">
        <span className="text-white text-[11px] font-bold">Goods Return Request</span>
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden bg-[#f0f0f0]">
        ...
        <div className="flex gap-8">
          ...
          <div className="w-[200px]">
             ...
             <FieldRow label="Return Date" labelWidth="80px">
                <ClassicInput className="w-full" />
             </FieldRow>
        ...
        <div className="flex-1 bg-white border border-[#808080] border-t-0 flex flex-col overflow-hidden">
          {activeTab === 'Contents' && <ContentsTabGRR />}
          {activeTab === 'Logistics' && <LogisticsTabGRR />}
          {activeTab === 'Accounting' && <AccountingTabGRR />}
          {activeTab === 'Attachments' && <AttachmentsTabGRR />}
        </div>
        ...
        <div className="flex justify-between mt-1 items-end">
           ...
           <div className="flex flex-col gap-1 w-[250px]">
              ...
              <div className="flex gap-2 items-center mb-1">
                ...
                <ClassicInput value="0.00" className="w-[45px] text-right" />
              ...
              <FieldRow label="Total Credit" labelWidth="120px">
