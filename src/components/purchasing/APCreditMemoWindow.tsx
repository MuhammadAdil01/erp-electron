...
import { ContentsTabAPCM } from './tabs/ContentsTabAPCM';
import { LogisticsTabAPCM } from './tabs/LogisticsTabAPCM';
import { AccountingTabAPCM } from './tabs/AccountingTabAPCM';
import { AttachmentsTabAPCM } from './tabs/AttachmentsTabAPCM';
...
interface APCreditMemoWindowProps {
...
export const APCreditMemoWindow: React.FC<APCreditMemoWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default">
        <span className="text-white text-[11px] font-bold">A/P Credit Memo</span>
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden bg-[#f0f0f0]">
          ...
          <div className="w-[200px]">
             <div className="flex items-center gap-1 mb-1">
                ...
                <div className="flex gap-0.5">
                   <ClassicInput value="1" className="w-[50px] text-right" readOnly />
                </div>
             </div>
        ...
        <div className="flex-1 bg-white border border-[#808080] border-t-0 flex flex-col overflow-hidden">
          {activeTab === 'Contents' && <ContentsTabAPCM />}
          {activeTab === 'Logistics' && <LogisticsTabAPCM />}
          {activeTab === 'Accounting' && <AccountingTabAPCM />}
          {activeTab === 'Attachments' && <AttachmentsTabAPCM />}
        </div>
        ...
        <div className="flex justify-between mt-1 items-end">
           ...
           <div className="flex flex-col gap-1 w-[280px]">
              ...
              <FieldRow label="Total Credit" labelWidth="130px">
              ...
              <FieldRow label="Open Balance" labelWidth="130px"><ClassicInput className="w-full bg-[#f0f0f0]" readOnly /></FieldRow>
           </div>
        </div>
