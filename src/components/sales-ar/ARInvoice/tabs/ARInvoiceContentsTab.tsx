...
export const ARInvoiceContentsTab: React.FC = () => {
  const columns = [
    { label: '#', width: '30px' },
    { label: 'Description', width: '200px' },
    { label: 'G/L Account', width: '120px' },
    { label: 'Distr. Rule', width: '100px' },
    { label: 'G/L Account Name', width: '200px' },
    { label: 'Tax Code', width: '80px' },
    { label: 'WTax Liable', width: '100px' },
    { label: 'Total (LC)', width: '120px' },
    { label: 'Blanket Agreement No.', width: '150px' },
    { label: 'Retention %', width: '100px' },
    { label: 'IPC No.', width: '80px' },
    { label: 'Rejected Quantity', width: '120px' }
  ];
       ...
       <div className="flex items-center justify-between mb-2 px-1">
          <div className="flex items-center gap-2">
             ...
             <div className="relative group">
                <input type="text" defaultValue="Service" className="w-[100px] border border-gray-400 h-[18px] px-1 text-[11px] outline-none" />
             ...
             <div className="flex-1 overflow-auto custom-scrollbar">
                <div className="min-w-fit">
                   <div className="flex border-b border-gray-200 h-[18px] bg-white">
                      ...
                      <div style={{ width: '100px' }} className="border-r border-gray-200 h-full" />
                      <div style={{ width: '200px' }} className="border-r border-gray-200 h-full bg-[#f0f0f0]" />
                      <div style={{ width: '80px' }} className="px-2 flex items-center text-[10px] font-bold border-r border-gray-200 h-full">S1</div>
                      <div style={{ width: '100px' }} className="px-2 flex items-center text-[10px] border-r border-gray-200 h-full">No</div>
                      <div style={{ width: '120px' }} className="border-r border-gray-200 h-full" />
                      <div style={{ width: '150px' }} className="border-r border-gray-200 h-full" />
                      <div style={{ width: '100px' }} className="px-2 flex items-center justify-end text-[10px] border-r border-gray-200 h-full">0.00</div>
