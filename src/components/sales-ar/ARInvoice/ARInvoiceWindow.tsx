...
import { ARInvoiceContentsTab } from './tabs/ARInvoiceContentsTab';
import { LogisticsTab } from './tabs/LogisticsTab';
import { AccountingTab } from './tabs/AccountingTab';
import { ARInvoiceAttachmentsTab } from './tabs/ARInvoiceAttachmentsTab';
...
interface ARInvoiceWindowProps {
...
export const ARInvoiceWindow: React.FC<ARInvoiceWindowProps> = ({
  windowState,
  onClose,
  onUpdateState,
  onFocus
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-black text-[12px] font-medium truncate">A/R Invoice</span>
        <WindowControls
          onClose={onClose}
      ...
      <div className="flex-1 flex flex-col p-2 gap-4 overflow-hidden pt-4">
         ...
         <div className="grid grid-cols-[1fr_350px] gap-x-12 shrink-0 px-1">
            ...
            <div className="flex flex-col gap-1">
               <div className="flex items-center gap-1">
                  <label className="w-[100px] text-[11px] text-gray-700">Referred</label>
               ...
               <div className="flex items-center gap-1">
                  <label className="w-[100px] text-[11px] text-gray-700">Depositor Name</label>
                  <input type="text" className={sapInputStyle} />
               </div>
            </div>
         ...
         <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 border border-gray-400 bg-white overflow-hidden flex flex-col p-1 pt-2">
               {activeTab === 'Contents' && <ARInvoiceContentsTab />}
               {activeTab === 'Logistics' && <LogisticsTab />}
               {activeTab === 'Accounting' && <AccountingTab />}
               {activeTab === 'Attachments' && <ARInvoiceAttachmentsTab />}
            </div>
         </div>
               ...
               <div className="flex items-center mt-2">
                  ...
                  <div className="w-[140px] flex items-center justify-between h-[20px] border border-gray-400 px-1 bg-white relative">
                     ...
                     <div className="absolute right-[-22px] top-0 flex items-center justify-center h-full">
                        <div className="w-[18px] h-[18px] bg-yellow-100 border border-yellow-600 flex items-center justify-center">
