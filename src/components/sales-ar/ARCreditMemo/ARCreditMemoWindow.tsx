...
import { ARCreditMemoContentsTab } from './tabs/ARCreditMemoContentsTab';
import { LogisticsTab } from './tabs/LogisticsTab';
import { AccountingTab } from './tabs/AccountingTab';
import { ARCreditMemoAttachmentsTab } from './tabs/ARCreditMemoAttachmentsTab';
...
interface ARCreditMemoWindowProps {
...
export const ARCreditMemoWindow: React.FC<ARCreditMemoWindowProps> = ({
  windowState,
  onClose,
  onUpdateState,
  onFocus
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-black text-[12px] font-medium truncate">A/R Credit Memo</span>
        <WindowControls
          onClose={onClose}
      ...
      <div className="flex-1 flex flex-col p-2 gap-4 overflow-hidden pt-4">
               ...
               <div className="flex items-center gap-1">
                  ...
                  <div className="flex flex-1 gap-1">
                     <div className="w-[100px] relative">
                        <input type="text" defaultValue="DHAB-ARC" className={sapInputStyle} />
                        <div className="absolute right-0 top-0 bottom-0 w-[18px] bg-gradient-to-b from-[#fefefe] to-[#d1d1d1] border-l border-gray-400 flex items-center justify-center cursor-pointer">
                           <ChevronDown className="w-3.5 h-3.5 text-gray-600" />
                        </div>
                     </div>
                     <input type="text" defaultValue="744" className={sapInputStyle} />
                  </div>
               </div>
               <div className="flex items-center gap-1">
         ...
         <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 border border-gray-400 bg-white overflow-hidden flex flex-col p-1 pt-2">
               {activeTab === 'Contents' && <ARCreditMemoContentsTab />}
               {activeTab === 'Logistics' && <LogisticsTab />}
               {activeTab === 'Accounting' && <AccountingTab />}
               {activeTab === 'Attachments' && <ARCreditMemoAttachmentsTab />}
            </div>
         </div>
         ...
         <div className="grid grid-cols-[1fr_350px] gap-x-12 shrink-0 px-1">
            ...
            <div className="flex flex-col gap-1">
               ...
               <div className="flex items-center">
                  <label className="flex-1 text-[11px] text-gray-700">Open Balance</label>
                  <input type="text" disabled className="w-[140px] h-[18px] border border-gray-400 px-1 text-right text-[11px] bg-[#f0f0f0]" />
               </div>
            </div>
         </div>
