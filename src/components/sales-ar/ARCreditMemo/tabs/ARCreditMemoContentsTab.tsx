...
export const ARCreditMemoContentsTab: React.FC = () => {
  const columns = [
    { label: '#', width: '30px' },
    ...
    { label: 'Enable Setting Cost', width: '120px' },
    { label: 'Return Cost (LC)', width: '120px' },
    { label: 'Blanket Agreement No.', width: '150px' },
    { label: 'Standard Item Identification', width: '180px' },
    { label: 'Commodity Cl...', width: '120px' }
  ];
             ...
             <div className="flex-1 overflow-auto custom-scrollbar">
                <div className="min-w-fit">
                   <div className="flex border-b border-gray-200 h-[18px] bg-white">
                      ...
                      <div style={{ width: '120px' }} className="border-r border-gray-200 h-full flex items-center justify-center">
                         <input type="checkbox" className="w-[12px] h-[12px]" />
                      </div>
                      <div style={{ width: '120px' }} className="px-2 flex items-center justify-end text-[10px] border-r border-gray-200 h-full">0.00</div>
