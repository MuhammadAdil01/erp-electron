...
export const SalesOrderWindow: React.FC<SalesOrderWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-black text-[12px] font-medium truncate">Sales Order</span>
        <WindowControls
          onClose={onClose}
         ...
         <div className="grid grid-cols-[1fr_350px] gap-x-12 shrink-0 px-1">
            ...
            <div className="flex flex-col gap-1">
               <div className="flex items-center gap-1">
                  ...
                  <div className="flex flex-1 gap-1">
                     <div className="w-[100px] relative">
                        <input type="text" defaultValue="...B-SO" className={sapInputStyle} />
                        <div className="absolute right-0 top-0 bottom-0 w-[18px] bg-gradient-to-b from-[#fefefe] to-[#d1d1d1] border-l border-gray-400 flex items-center justify-center cursor-pointer">
                           <ChevronDown className="w-3.5 h-3.5 text-gray-600" />
                        </div>
                     </div>
               ...
               <div className="flex items-center gap-1">
                  ...
                  <input type="text" defaultValue="30.03.26" className={sapInputStyle} />
               </div>
               <div className="flex items-center gap-1">
