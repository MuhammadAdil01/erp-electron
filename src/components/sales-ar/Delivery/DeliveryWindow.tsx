...
import { DeliveryContentsTab } from './tabs/DeliveryContentsTab';
import { LogisticsTab } from '../SalesOrder/tabs/LogisticsTab';
import { AccountingTab } from '../SalesOrder/tabs/AccountingTab';
import { SalesOrderAttachmentsTab } from '../SalesOrder/tabs/SalesOrderAttachmentsTab';
...
export const DeliveryWindow: React.FC<DeliveryWindowProps> = ({
  windowState,
  onClose,
  onUpdateState,
  onFocus
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-black text-[12px] font-medium truncate">Delivery</span>
        <WindowControls
          onClose={onClose}
      ...
      <div className="flex-1 flex flex-col p-2 gap-4 overflow-hidden pt-4">
               ...
               <div className="flex items-center gap-1">
                  ...
                  <div className="flex flex-1 gap-1">
                     <div className="w-[100px] relative">
                        <input type="text" defaultValue="B-DEL" className={sapInputStyle} />
                        <div className="absolute right-0 top-0 bottom-0 w-[18px] bg-gradient-to-b from-[#fefefe] to-[#d1d1d1] border-l border-gray-400 flex items-center justify-center cursor-pointer">
                           <ChevronDown className="w-3.5 h-3.5 text-gray-600" />
                        </div>
                     </div>
         ...
         <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 border border-gray-400 bg-white overflow-hidden flex flex-col p-1 pt-2">
               {activeTab === 'Contents' && <DeliveryContentsTab />}
