...
import { ARDownPaymentInvoiceContentsTab } from './tabs/ARDownPaymentInvoiceContentsTab';
import { LogisticsTab } from './tabs/LogisticsTab';
import { AccountingTab } from './tabs/AccountingTab';
import { ARDownPaymentInvoiceAttachmentsTab } from './tabs/ARDownPaymentInvoiceAttachmentsTab';
...
interface ARDownPaymentInvoiceWindowProps {
...
export const ARDownPaymentInvoiceWindow: React.FC<ARDownPaymentInvoiceWindowProps> = ({
  windowState,
  onClose,
  onUpdateState,
  onFocus
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-black text-[12px] font-medium truncate">A/R Down Payment Invoice</span>
        <WindowControls
          onClose={onClose}
      ...
      <div className="flex-1 flex flex-col p-2 gap-4 overflow-hidden pt-4">
         ...
         <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 border border-gray-400 bg-white overflow-hidden flex flex-col p-1 pt-2">
               {activeTab === 'Contents' && <ARDownPaymentInvoiceContentsTab />}
               {activeTab === 'Logistics' && <LogisticsTab />}
               {activeTab === 'Accounting' && <AccountingTab />}
               {activeTab === 'Attachments' && <ARDownPaymentInvoiceAttachmentsTab />}
            </div>
         </div>
