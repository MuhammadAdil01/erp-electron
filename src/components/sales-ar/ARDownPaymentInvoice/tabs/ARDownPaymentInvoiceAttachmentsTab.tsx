...
export const ARDownPaymentInvoiceAttachmentsTab: React.FC = () => {
  const columns = [
    { label: '#', width: '30px' },
    ...
    <div className="flex gap-4 h-full pt-4 select-none px-2 overflow-hidden">
       ...
       <div className="w-[100px] flex flex-col gap-2 shrink-0">
          <div className="relative group/btn">
             <button className="w-full h-[20px] bg-gradient-to-b from-[#fff6d5] via-[#ffec99] to-[#ffd000]/60 border border-gray-500 text-[11px] font-bold shadow-sm rounded-[1px] text-left px-2 flex items-center">
                Browse
             </button>
