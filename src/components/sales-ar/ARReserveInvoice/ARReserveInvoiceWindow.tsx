...
import { ARReserveInvoiceContentsTab } from './tabs/ARReserveInvoiceContentsTab';
import { LogisticsTab } from './tabs/LogisticsTab';
import { AccountingTab } from './tabs/AccountingTab';
import { ARReserveInvoiceAttachmentsTab } from './tabs/ARReserveInvoiceAttachmentsTab';
...
interface ARReserveInvoiceWindowProps {
...
const sapGreyButtonStyle = "px-3 h-[20px] bg-gradient-to-b from-[#fefefe] to-[#d1d1d1] border border-gray-400 text-[11px] shadow-sm rounded-[1px] min-w-[70px] hover:brightness-95 active:shadow-inner flex items-center justify-center";

export const ARReserveInvoiceWindow: React.FC<ARReserveInvoiceWindowProps> = ({
  windowState,
  onClose,
  onUpdateState,
  onFocus
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-black text-[12px] font-medium truncate">A/R Reserve Invoice</span>
        <WindowControls
          onClose={onClose}
      ...
      <div className="flex-1 flex flex-col p-2 gap-4 overflow-hidden pt-4">
         ...
         <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 border border-gray-400 bg-white overflow-hidden flex flex-col p-1 pt-2">
               {activeTab === 'Contents' && <ARReserveInvoiceContentsTab />}
               {activeTab === 'Logistics' && <LogisticsTab />}
               {activeTab === 'Accounting' && <AccountingTab />}
               {activeTab === 'Attachments' && <ARReserveInvoiceAttachmentsTab />}
            </div>
         </div>
