...
export const modulesData: MenuSubItem[] = [
        ...
        subItems: [
          {
            ...
            subItems: [
              ...
              { name: '..B Pay Slip', icon: checkedDocIcon },
  ...
  { 
    name: 'Sales - A/R', 
    icon: <TrendingUp className="w-3.5 h-3.5 text-blue-700" />,
    subItems: [
      { name: 'Sales Order', icon: subFileIcon },
      { name: 'Delivery', icon: subFileIcon },
      { name: 'Return Request', icon: subFileIcon },
      { name: 'Return', icon: subFileIcon },
      { name: 'A/R Down Payment Request', icon: subFileIcon },
      { name: 'A/R Down Payment Invoice', icon: subFileIcon },
      { name: 'A/R Invoice', icon: subFileIcon },
      { name: 'A/R Invoice + Payment', icon: subFileIcon },
      { name: 'A/R Credit Memo', icon: subFileIcon },
      { name: 'A/R Reserve Invoice', icon: subFileIcon },
      { name: 'Recurring Transactions', icon: subFileIcon },
      { name: 'Recurring Transaction Templates', icon: subFileIcon },
      { name: 'Document Printing', icon: subFileIcon },
      {
        name: 'Sales Reports',
        icon: subFolderIcon,
        subItems: [
          { name: 'Open Items List', icon: subFileIcon },
          { name: 'Document Drafts Report', icon: subFileIcon },
          { name: 'Sales Analysis', icon: subFileIcon },
          { name: 'Backorder', icon: subFileIcon },
          { name: 'Locate Exceptional Discount in Invoice', icon: questionDocIcon },
          { name: 'SP Commission by Invoices in Posting Date Cross-Section', icon: questionDocIcon },
          { name: 'Blanket Agreement Fulfillment Report', icon: subFileIcon },
        ],
      },
    ],
  },
