...
const TreeItem: React.FC<{
  ...
  const handleClick = (e: React.MouseEvent) => {
    ...
    const map: Record<string, WindowType> = {
      ...
      'Opportunity': 'opportunity', 'Sales Order': 'salesOrder', 'Delivery': 'delivery',
      'Customer 360': 'customer360', 'Return': 'salesReturn', 'A/R Down Payment Request': 'arDownPaymentRequest', 'A/R Down Payment Invoice': 'arDownPaymentInvoice', 'A/R Invoice': 'arInvoice', 'A/R Invoice + Payment': 'arInvoicePayment', 'A/R Credit Memo': 'arCreditMemo', 'A/R Reserve Invoice': 'arReserveInvoice', 'Document Drafts Report': 'documentDraftsReport', 'Sales Analysis': 'salesAnalysisReport', 'Backorder': 'backorderReport', 'Blanket Agreement Fulfillment Report': 'blanketAgreementFulfillmentReport',
      ...
      'SAP Links': 'sapLinks',
      'License Administration': 'licenseAdministration',
      'Add-On Identifier Generator': 'addOnIdentifierGenerator',
      'Support User Log': 'supportUserLog',
      'License Information': 'licenseInformation',
      'Alerts Management': 'alertsManagement',
      'Period-End Closing': 'periodEndClosing',
      'Check Document Numbering': 'checkDocumentNumbering',
      'Duplicate Layout Template': 'duplicateLayoutTemplate',
      'Master Data Cleanup Wizard': 'masterDataCleanupWizard',
      'Manual Master Data Series Converter': 'manualMasterDataSeriesConverter',
      'UI Configuration Template': 'uiConfigurationTemplate',
      'Connected Clients': 'connectedClients',
      'Change Logs Cleanup': 'changeLogsCleanup',
      'Approval Stages': 'approvalStages',
      'Approval Templates': 'approvalTemplates',
      'Approval Status Report': 'approvalStatusReport',
      'Approval Decision Report': 'approvalDecisionReport',
      'Substitute Authorizer for Approval Templates': 'substituteAuthorizer',
