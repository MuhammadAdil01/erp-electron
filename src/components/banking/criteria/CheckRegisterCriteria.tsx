...
interface CheckRegisterCriteriaProps {
...
export const CheckRegisterCriteria: React.FC<CheckRegisterCriteriaProps> = ({
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className='h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default shrink-0'>
        <span className='text-white text-[11px] font-bold'>Check Register - Selection Criteria</span>
      ...
      <div className='flex-1 p-4 flex flex-col gap-0.5 overflow-y-auto custom-scrollbar'>
        ...
        <Row label='Date of Receipt'><FromTo /></Row>
        <Row label='Check Number'><FromTo /></Row>
        <Row label='Check Amount'><FromTo /></Row>
        
        <Row label='Deposit Status'>
          <ClassicSel className='w-[160px]'><option>All</option></ClassicSel>
        </Row>
        <Row label='Endorsed'>
          <ClassicSel className='w-[160px]'><option>All</option></ClassicSel>
        </Row>
