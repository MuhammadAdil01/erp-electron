...
import { ContentsTabIncomingPayments } from './tabs/ContentsTabIncomingPayments';
import { AttachmentsTabIncomingPayments } from './tabs/AttachmentsTabIncomingPayments';
...
interface IncomingPaymentsWindowProps {
...
export const IncomingPaymentsWindow: React.FC<IncomingPaymentsWindowProps> = ({
  windowState, onClose, onUpdateState, onFocus
}) => {
  const [activeTab, setActiveTab] = useState('Contents');
  const [bpType, setBpType] = useState('Customer');
  ...
  return (
    ...
    >
      ...
      <div onMouseDown={handleDrag} className="h-[24px] bg-gradient-to-b from-[#808080] to-[#606060] flex items-center justify-between px-2 cursor-default shrink-0">
        <span className="text-white text-[11px] font-bold">Incoming Payments</span>
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden bg-[#f0f0f0]">
        ...
        <div className="flex gap-4 justify-between shrink-0">
          ...
          <div className="grid grid-cols-[100px_1fr] gap-x-2 gap-y-0.5 flex-1 min-w-[250px] max-w-[350px]">
            ...
            <div className="text-[10.5px]">Bill To</div>
            <div className="flex gap-1">
          ...
          <div className="grid grid-cols-[100px_1fr] gap-x-2 gap-y-0.5 min-w-[220px] max-w-[280px]">
            ...
            <div className="flex gap-1">
              <ClassicSel className="w-[70px]"><option>DHAB-IP</option></ClassicSel>
              <ClassicInput value="50145" className="flex-1 text-right bg-[#f0f0f0]" readOnly />
            </div>
        ...
        <div className="flex-1 bg-white border border-[#808080] border-t-0 flex flex-col overflow-hidden">
          {activeTab === 'Contents' && <ContentsTabIncomingPayments />}
          {activeTab === 'Attachments' && <AttachmentsTabIncomingPayments />}
        </div>
        ...
        <div className="flex justify-between mt-0.5 items-end shrink-0">
          <div className="flex flex-col gap-1 flex-1">
            <div className="grid grid-cols-[100px_1fr] gap-x-2 gap-y-1 w-[400px]">
              <div className="text-[10.5px]">Banking Remarks</div>
              <ClassicInput className="w-full" />
          ...
          <div className="flex gap-1.5 self-end">
            ...
            <YellowBtn className="min-w-[120px]">Add in Sequence</YellowBtn>
          </div>
        </div>
      </div>
    </div>
