...
interface FamilyDetailWindowProps {
  show: boolean;
  onClose: () => void;
...
export const FamilyDetailWindow: React.FC<FamilyDetailWindowProps> = ({ 
  show, 
  onClose, 
  windowState, 
  setWindowState 
  ...
  const headers = ["#", "LineId", "Name", "Relation", "DOB"];
    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5 min-w-0">
          ...
          <span className="text-white font-semibold text-[11.5px] tracking-wide drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)] truncate">Family Detail</span>
        </div>
        <WindowControls 
