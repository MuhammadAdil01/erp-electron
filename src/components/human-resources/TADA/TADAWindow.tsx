...
export const TADAWindow: React.FC<TADAWindowProps> = ({ 
  show, 
  onClose, 
  windowState, 
  setWindowState 
  ...
  const headers = ["#", "LineId", "Date", "Expense Type", "Amount", "Bill"];
    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5 min-w-0">
          ...
          <span className="text-white font-semibold text-[11.5px] tracking-wide drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)] truncate">TA / DA</span>
        </div>
        <WindowControls 
      ...
      <div className="flex-1 flex flex-col overflow-auto custom-scrollbar bg-[#f0f0f0]">
        ...
        <div className="grid grid-cols-2 gap-x-12 p-4 pt-4">
           ...
           <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Status</label>
                 <input type="text" defaultValue="O" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Creator</label>
                 <input type="text" disabled className="flex-1 bg-[#e1e1e1] border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)]" />
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Designation</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Grade</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Location</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">To</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Reason of Travel</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
           </div>
           {/* Right Col */}
           <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">CreateDate</label>
                 <input type="text" disabled className="flex-1 bg-[#e1e1e1] border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)]" />
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Phone</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">Department</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">From</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
              <div className="flex items-center">
                 <label className="text-gray-700 w-[100px]">.... No</label>
                 <input type="text" className="flex-1 bg-white border border-gray-400 h-[18px] px-1 shadow-[inset_1px_1px_1px_rgba(0,0,0,0.05)] outline-none" />
              </div>
           </div>
        </div>
        ...
        {/* Tabs */}
        <div className="flex px-4 mt-6 shrink-0 h-[24px]">
          {['Traveling Allowance', 'Daily Allowance'].map(tab => (
            <div 
              key={tab}
              onClick={() => setActiveTab(tab)}
              className={`px-6 flex items-center justify-center cursor-pointer border border-gray-400 border-b-0 rounded-t-[4px] mr-[2px] transition-all relative ${activeTab === tab ? 'bg-white font-bold h-[25px] z-10 shadow-sm' : 'bg-[#e0e0e0] h-[22px] mt-[2px] hover:bg-white text-gray-600 hover:text-black'}`}
            >
        ...
        {/* Data Grid Area */}
        <div className="flex-1 mx-4 mb-4 border border-gray-400 bg-white p-6 pt-4 shadow-[0_2px_10px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col">
           <div className="flex-1 border border-gray-300 overflow-auto relative custom-scrollbar bg-white shadow-inner">
              <table className="w-full border-collapse table-fixed">
                 ...
                 <tbody>
                    <tr className="border-b border-gray-100 h-[20px] bg-blue-50/10">
                      <td className="bg-[#f5f5f5] border-r border-gray-300 text-center text-gray-500 font-bold text-[10px] select-none">1</td>
                      <td className="border-r border-gray-200"></td>
                      <td className="border-r border-gray-200 px-1 py-0.5"></td>
                      <td className="border-r border-gray-200 px-1 py-0.5"></td>
                      <td className="border-r border-gray-200 px-1 py-0.5"></td>
