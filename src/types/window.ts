...
export type WindowType =
  ...
  | 'periodEndClosing' | 'selectionAccounts' | 'checkDocumentNumbering' | 'duplicateLayoutTemplate'
  | 'masterDataCleanupWizard' | 'manualMasterDataSeriesConverter' | 'selectionItems' | 'uiConfigurationTemplate' | 'connectedClients' | 'changeLogsCleanup' | 'approvalStages' | 'approvalTemplates' | 'approvalStatusReport' | 'approvalDecisionReport' | 'selectionUsersList'
