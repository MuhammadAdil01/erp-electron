...
export function useWindowManager() {
  ...
  const [employeeWindow,                    setEmployeeWindow]                    = useState({ x: 100, y: 50, width: 900, height: 550, isMinimized: false, isMaximized: true, zIndex: 10 });
  const [timeSheetWindow,                   setTimeSheetWindow]                   = useState({ x: 150, y: 80, width: 1000, height: 650, isMinimized: false, isMaximized: true, zIndex: 11 });
  const [familyDetailWindow,                setFamilyDetailWindow]                = useState({ x: 200, y: 120, width: 800, height: 500, isMinimized: false, isMaximized: true, zIndex: 12 });
  const [nextOfKinWindow,                   setNextOfKinWindow]                   = useState({ x: 250, y: 150, width: 800, height: 500, isMinimized: false, isMaximized: true, zIndex: 13 });
  const [finalSettlementWindow,             setFinalSettlementWindow]             = useState({ x: 300, y: 180, width: 800, height: 550, isMinimized: false, isMaximized: true, zIndex: 14 });
  const [tadaWindow,                        setTadaWindow]                        = useState({ x: 350, y: 210, width: 900, height: 600, isMinimized: false, isMaximized: true, zIndex: 15 });
  const [bpMasterWindow,                    setBpMasterWindow]                    = useState({ x: 50, y: 40, width: 1100, height: 700, isMinimized: false, isMaximized: true, zIndex: 16 });
  const [activityWindow,                    setActivityWindow]                    = useState({ x: 80, y: 60, width: 1050, height: 680, isMinimized: false, isMaximized: true, zIndex: 17 });
  const [opportunityWindow,                 setOpportunityWindow]                 = useState({ x: 40, y: 30, width: 1150, height: 720, isMinimized: false, isMaximized: true, zIndex: 18 });
  const [salesOrderWindow,                  setSalesOrderWindow]                  = useState({ x: 120, y: 90, width: 1100, height: 750, isMinimized: false, isMaximized: true, zIndex: 19 });
  const [customer360Window,                 setCustomer360Window]                 = useState({ x: 60, y: 50, width: 1200, height: 800, isMinimized: false, isMaximized: true, zIndex: 20 });
  const [activitiesWindow,                  setActivitiesWindow]                  = useState({ x: 150, y: 120, width: 500, height: 650, isMinimized: false, isMaximized: true, zIndex: 21 });
  const [campaignsWindow,                   setCampaignsWindow]                   = useState({ x: 200, y: 140, width: 500, height: 750, isMinimized: false, isMaximized: true, zIndex: 22 });
  const [inactiveCustWindow,                setInactiveCustWindow]                = useState({ x: 250, y: 160, width: 500, height: 300, isMinimized: false, isMaximized: true, zIndex: 23 });
  const [oppStatsWindow,                    setOppStatsWindow]                    = useState({ x: 300, y: 180, width: 650, height: 500, isMinimized: false, isMaximized: true, zIndex: 24 });
  const [wonOppWindow,                      setWonOppWindow]                      = useState({ x: 350, y: 200, width: 450, height: 400, isMinimized: false, isMaximized: true, zIndex: 25 });
  ...
  const [chooseCompanyWindowPos,            setChooseCompanyWindowPos]            = useState({ x: 100, y: 100, width: 850, height: 600, isMinimized: false, isMaximized: true, zIndex: 67 });
  const [exchangeRatesWindowPos,            setExchangeRatesWindowPos]            = useState({ x: 100, y: 100, width: 900, height: 650, isMinimized: false, isMaximized: true, zIndex: 68 });
  const [companyDetailsWindowPos,           setCompanyDetailsWindowPos]           = useState({ x: 100, y: 100, width: 700, height: 800, isMinimized: false, isMaximized: true, zIndex: 69 });
  const [generalSettingsWindowPos,          setGeneralSettingsWindowPos]          = useState({ x: 100, y: 100, width: 950, height: 650, isMinimized: false, isMaximized: true, zIndex: 70 });
  const [postingPeriodsWindowPos,           setPostingPeriodsWindowPos]           = useState({ x: 100, y: 100, width: 1000, height: 650, isMinimized: false, isMaximized: true, zIndex: 71 });
  const [documentNumberingWindowPos,        setDocumentNumberingWindowPos]        = useState({ x: 100, y: 100, width: 1000, height: 700, isMinimized: false, isMaximized: true, zIndex: 72 });
  const [documentSettingsWindowPos,         setDocumentSettingsWindowPos]         = useState({ x: 100, y: 100, width: 1000, height: 700, isMinimized: false, isMaximized: true, zIndex: 73 });
  const [printPreferencesWindowPos,         setPrintPreferencesWindowPos]         = useState({ x: 100, y: 100, width: 620, height: 580, isMinimized: false, isMaximized: true, zIndex: 74 });
  const [tooltipPreviewWindowPos,          setTooltipPreviewWindowPos]           = useState({ x: 100, y: 100, width: 1000, height: 600, isMinimized: false, isMaximized: true, zIndex: 75 });
  const [companyAdminWindowPos,           setCompanyAdminWindowPos]            = useState({ x: 100, y: 80, width: 960, height: 680, isMinimized: false, isMaximized: true, zIndex: 76 });
  ...
  const [passwordAdminWindowPos,         setPasswordAdminWindowPos]          = useState({ x: 100, y: 100, width: 450, height: 400, isMinimized: false, isMaximized: true, zIndex: 91 });
  const [changePasswordWindowPos,        setChangePasswordWindowPos]         = useState({ x: 100, y: 100, width: 400, height: 300, isMinimized: false, isMaximized: true, zIndex: 92 });
  const [siteUserWindowPos,              setSiteUserWindowPos]               = useState({ x: 100, y: 100, width: 500, height: 450, isMinimized: false, isMaximized: true, zIndex: 93 });
